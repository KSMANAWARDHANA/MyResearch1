...
class Student:
    def __init__(self, root):
        ...
        img = Image.open(r"images\fac.jpg")
        img = img.resize((1100,100), Image.ANTIALIAS)
        self.photoimg = ImageTk.PhotoImage(img)

        f_lbl = Label(self.root, image=self.photoimg)
        f_lbl.place(x=0, y=-10, width=1300, height=150)
        ...
        # # second image
        # img1 = Image.open(r"C:\Users\Vista\Desktop\images\student2.jpg")
        ...
        # # third image
        # img2 = Image.open(r"C:\Users\Vista\Desktop\images\student2.jpg")
        ...
        course_combo = ttk.Combobox(current_course_frame, textvariable=self.var_course,
                                    font=("times new roman", 12, "bold"), width=17)
        course_combo["values"] = ("Select course", "SE", "data com", "Network", "DBMS")
        ...
        # student Reg No
        studentId_label = Label(class_Student_frame, text="Student Reg No", font=("times new roman", 12, "bold"),
                                state="active")
        ...
        # Lecturer Name
        lecturerName_label = Label(class_Student_frame, text="Lecturer Name", font=("times new roman", 12, "bold"),
                                   state="active")
        ...
        # update_photo_btn = Button(btn_frame, text="Update photo sample", width=15, font=("times new roman", 10, "bold"),
        #                           bg="blue",
        #                           fg="white")
        ...
        search_combo["values"] = ("Select", "student reg no", "student name")
        ...
        self.student_table.heading("regNo", text="RegNo")
        self.student_table.heading("name", text="Student Name")
        self.student_table.heading("lecturer", text="Lecturer Name")
