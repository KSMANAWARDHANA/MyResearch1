...
class Face_Recognition_System:
    def __init__(self, root):
     ...
     # first image
        ...
        img = img.resize((1200,100), Image.ANTIALIAS)
        self.photoimg = ImageTk.PhotoImage(img)

        f_lbl = Label(self.root, image=self.photoimg)
        f_lbl.place(x=50, y=0, width=1200, height=100)

#         # second image
#         img1 = Image.open(r"C:\Users\Vista\Desktop\images\two.jpg")
...
#         # third image
#         img2 = Image.open(r"C:\Users\Vista\Desktop\images\three.jpg")
